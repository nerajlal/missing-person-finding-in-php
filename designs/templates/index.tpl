        ...
        <nav id="primary-navigation" class="site-navigation">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="site-title"><span>Anonymous</span>Person</a>
                ...
                <div class="collapse navbar-collapse" id="agency-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                       ...
                       <li class="dropdown"><a href="" class="dropdown-toggle" data-toggle="dropdown">REGISTER <i class="fa fa-caret-down hidden-xs" aria-hidden="true"></i></a>

                            <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                               <li><a href="policereg.php"">POLICE</a></li> 
                              <li><a href="hospitalreg.php">HOSPITAL </a></li>
...
<li><a href="login.php">LOGIN</a></li>
                                <li><a href="passstatusviewmissing.php">MISSING PERSON</a></li>
    ...
    <main id="main" class="site-main">
        ...
        <section class="site-section section-features">
            <div class="container">
                <div class="row">
                    <div class="col-sm-5">
                        <h2>Anonymous person Finding</h2>
                        <p>Anonymous person finding is a web based system developed in PHP programming language. A missing person is a person who has disappeared and whose status as alive or dead cannot be confirmed as their location and fate are unknown.</p>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-3 col-xs-6">
                        <div class="service">
                            <img src="user/assets/img/anchor.svg" alt="">
                   ...
                   <!--  </div>
                    <div class="col-md-3 col-xs-6">
                        <div class="service">
                            <img src="user/assets/img/bycicle.svg" alt="">
                    ...
                    <div class="col-md-3 col-xs-6">
                        <div class="service">
                            <img src="user/assets/img/paper-plane.svg" alt="">
                   ...
                   <!--  </div>
                    <div class="col-md-3 col-xs-6">
                        <div class="service">
                            <img src="user/assets/img/photo.svg" alt="">
                  ...
                  <!--   </div>
                    <div class="col-md-3 col-xs-6">
                        <div class="service">
                            <img src="user/assets/img/microphone.svg" alt="">
                ...
                <!--     </div>
                    <div class="col-md-3 col-xs-6">
                        <div class="service">
                            <img src="user/assets/img/rocket.svg" alt="">
                    ...
                    <div class="col-md-3 col-xs-6">
                        <div class="service">
                            <img src="user/assets/img/basket.svg" alt="">
               ...
               <!--      </div>
                    <div class="col-md-3 col-xs-6">
                        <div class="service">
                            <img src="user/assets/img/chemestry.svg" alt="">
